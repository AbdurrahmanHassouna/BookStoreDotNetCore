...
namespace AprilBookStore.Infrastructure.Migrations
{
    ...
    [Migration("20260920084622_ModernizeDomainTypes")]
    partial class ModernizeDomainTypes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AprilBookStore.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "d73fe18c-f33f-40a8-9ec4-138c56657648",
                            Email = "test@test.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "TEST@TEST.COM",
                            NormalizedUserName = "ABDO",
                            PasswordHash = "AQAAAAEAACcQAAAAEMxJlpDMRLasGdg341WRjtGWCZp94qxLX+t+bF89PWUNksJ6r9LgUc2iFd9DCBl/+A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "2bcf0f10-cb46-45b4-8b54-a1783f1f3778",
            ...
            modelBuilder.Entity("AprilBookStore.Domain.Entities.Book", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_Book_QuantityInStock", "[QuantityInStock] >= 0");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 7.60m,
                            PublicationDate = new DateTime(2023, 12, 8, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            QuantityInStock = 9,
                            UpdatedDate = new DateTime(2023, 12, 8, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
            ...
            modelBuilder.Entity("AprilBookStore.Domain.Entities.CartItem", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_CartItem_Quantity", "[Quantity] > 0");
                });
            ...
            modelBuilder.Entity("AprilBookStore.Domain.Entities.CartItem", b =>
                {
                    ...
                    b.HasOne("AprilBookStore.Domain.Entities.ApplicationUser", null)
                        .WithMany("CartItems")
